...
private String library;
    ...
    public runTophat2andHtseq(String library, String gffpath, String fastqfile1,boolean issingle) throws IOException {
    ...
    public runTophat2andHtseq(String library, String gffpath, String fastqfile1,String userdefinedname,boolean issingle) throws IOException {
        this.library = library;
        this.gffpath = new File(gffpath).getAbsolutePath();
        this.fastqfile1 = new File(fastqfile1).getAbsolutePath();
    ...
    public runTophat2andHtseq(String library, String gffpath, String fastqfile1, String fastqfile2) throws IOException {
        this.library = library;
        this.gffpath = new File(gffpath).getAbsolutePath();
        this.fastqfile1 = new File(fastqfile1).getAbsolutePath();
     ...
     public runTophat2andHtseq(String library, String gffpath, String fastqfile1, String fastqfile2,String userdefinedname) throws IOException {
        this.library = library;
        this.gffpath = new File(gffpath).getAbsolutePath();
        this.fastqfile1 = new File(fastqfile1).getAbsolutePath();
        this.fastqfile2 = new File(fastqfile2).getAbsolutePath();
    ...
    public void runTophat2HTseqGetCountfilePaired() throws IOException {
        ...
        //run bowtie2
        System.out.println("start run tophat2...");
        String samfile = this.filename + ".sam";
        String bamfile = this.filename + ".bam";
        int random=(int) (100000*Math.random());
        String tempname="temp_"+random+".sh";
        File tempfile=new File(tempname);
//        tempfile.deleteOnExit();
            FileWriter fw = new FileWriter(tempfile);
            fw.append("#!/bin/sh\n");
            fw.append("tophat2 -o "+tophatoutdir+" -p "+tophatProcess+" -G " + this.gffpath + " " + this.library+" "+this.fastqfile1+" "+this.fastqfile2+"\n");
