...
public class BED {
    ...
    private double score;//A score between 0 and 1000. If the track line useScore attribute is set to 1 for this annotation data set, the score value will determine the level of gray in which this feature is displayed (higher numbers = darker gray). This table shows the Genome Browser's translation of BED score values into shades of gray: 
    private String strand;// Defines the strand - either '+' or '-'. 
    private int thickStart;//The starting position at which the feature is drawn thickly (for example, the start codon in gene displays). 
    private int thickEnd;//The ending position at which the feature is drawn thickly (for example, the stop codon in gene displays)
    ...
    private int blockCount;//The number of blocks (exons) in the BED line. 
