...
//    }
//    
//    public void GVCsimp2tcgaMaf_main(String simpfile, String outfile,String sampleID) throws FileNotFoundException, IOException {
//        BufferedReader br = new BufferedReader(new java.io.FileReader(new File(simpfile)));
//        FileWriter fw = new FileWriter(outfile);
//
//        //skip header 
...
//            String dataStr = br.readLine().trim();
//            GVCsimp gv = GVCsimp_2_tcga4maf.parsingGVCsimp(dataStr);
//            MAF_maftools tm = GVCsimp_2_tcga4maf.GVCsimp_2_tcga4maf_forMaftools_covert(gv,simpfile );
//            fw.append(tm.toString()+"\n");
//            fw.flush();
//        }
//
